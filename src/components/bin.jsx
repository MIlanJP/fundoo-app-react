...
export default function Bin(props) {
  ...
  const calculateColumn=()=> {
    ...
    userData.map((data, index) => {
      ...
      unPinnedExtraSmallRow.push(<DeletedNotesView userData={data} />)

        if (index % 2 === 0) {
          unPinnedSmallerColumn1.push(<DeletedNotesView userData={data} />);
        } else {
          unPinnedSmallerColumn2.push(<DeletedNotesView userData={data} />);
        }
  
        if (mediumCount === 0) {
          unPinnedMediumColumn1.push(<DeletedNotesView userData={data} />);
          mediumCount = 2;
        } else if (mediumCount === 1) {
          unPinnedMediumColumn2.push(<DeletedNotesView userData={data} />);
        } else {
          unPinnedMediumColumn3.push(<DeletedNotesView userData={data} />);
         
        }
  
        if (largeCount === 0) {
          unPinnedLargeColumn1.push(<DeletedNotesView userData={data} />);
          largeCount = 5;
  
        } else if (largeCount === 1) {
          unPinnedLargeColumn2.push(<DeletedNotesView userData={data} />);
        } else if (largeCount === 2) {
          unPinnedLargeColumn3.push(<DeletedNotesView userData={data} />);
        } else if (largeCount === 3) {
          unPinnedLargeColumn4.push(<DeletedNotesView userData={data} />);
        } else if(largeCount === 4) {
          unPinnedLargeColumn5.push(<DeletedNotesView userData={data} />);
        }
        mediumCount--;
        largeCount--;
      }
...
return null
    ...
    userData.map((data, index) => {
      if(data.isPined  && data.isDeleted){
      pinnedExtraSmallRow.push(<DeletedNotesView userData={data} />)

        if (index % 2 === 0) {
          pinnedSmallerColumn1.push(<DeletedNotesView userData={data} />);
        } else {
          pinnedSmallerColumn2.push(<DeletedNotesView userData={data} />);
        }
  
        if (mediumCount === 0) {
          mediumCount = 3;
          pinnedMediumColumn1.push(<DeletedNotesView userData={data} />);
        } else if (mediumCount === 1) {
          pinnedMediumColumn2.push(<DeletedNotesView userData={data} />);
        } else {
          pinnedMediumColumn3.push(<DeletedNotesView userData={data} />);
        }
  
        if (largeCount === 0) {
          pinnedLargeColumn1.push(<DeletedNotesView userData={data} />);
          largeCount = 5;
        } else if (largeCount === 1) {
          pinnedLargeColumn2.push(<DeletedNotesView userData={data} />);
        } else if (largeCount === 2) {
          pinnedLargeColumn3.push(<DeletedNotesView userData={data} />);
        } else if (largeCount === 3) {
          pinnedLargeColumn4.push(<DeletedNotesView userData={data} />);
        } else if(largeCount === 4) {
          pinnedLargeColumn5.push(<DeletedNotesView userData={data} />);
        }
        mediumCount--;
    largeCount--;
      }
